 ...
 * 
 * 				200：表示成功
 * 				500：表示错误，错误信息在msg字段中（验证错误)
 * 				501：bean验证错误，不管多少个错误都以map形式返回(一次性要校验多个数据错误的时候使用)
 * 				502：拦截器拦截到用户token出错
 * 				555：异常抛出信息
 * 				556: 用户qq校验异常
...
public class IMOOCJSONResult {
    ...
    public static com.imooc3.utils.IMOOCJSONResult build(Integer status, String msg, Object data) {
